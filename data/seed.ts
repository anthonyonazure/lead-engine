...
const SAMPLE_LEADS = [
  {
    ...
    location: 'Phoenix, AZ',
    notes: 'Looking to remodel a 200 sqft kitchen. Have a Pinterest board. Hoping to start within 60 days, budget around $40k.',
  },
  {
    name: 'Daniel Kim',
  ...
  },
  {
    ...
    notes: 'Master bathroom shower is leaking into the ceiling below. Need someone out this week if possible.',
  },
  {
    ...
    jobType: null,
    location: null,
    notes: 'We help home services businesses scale revenue 10x with our SEO platform. Reply for a demo.',
  },
];

function seed() {
  console.log('[seed] clearing existing leads...');
  ...
  console.log(`[seed] inserted ${SAMPLE_LEADS.length} leads`);
}
